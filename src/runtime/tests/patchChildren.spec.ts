...
describe('element anchor order check', () => {
  test('tag order', () => {
    ...
    render(h('div', null, result.nodes), root);
    expect(root.children[1].innerHTML).toBe(result.html);
...
describe('fragment anchor order', () => {
  test('fragment to element', () => {
    render(h(Fragment, null, [h('div',null,'')]), root);
    expect(root.innerHTML).toBe('<div></div>');

    render(h('p',null,''), root);
...
describe('patchChildren', () => {
  ...
  test('text children => array children 1', () => {
    ...
    render(h(Fragment, null, [h('div',null,''), h('div',null,'')]), root);
  ...
  test('text children => array children 2', () => {
    ...
    render(h('div', null, [h('h1',null,''), h('h2',null,'')]), root);
